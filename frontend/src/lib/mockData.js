// Mock data para el panel de escribanía MercadoProp
...
export const alertas = [
  ...
  },
  {
    ...
    descripcion: 'Pendiente validación cruzada con banco emisor.',
    accion: 'Verificar comprobante en panel de pagos.',
...
export const eventos = [
  ...
  { fecha: '22/06', hora: '10:45', tipo: 'alerta', evento: 'Sistema detectó vencimiento previo a firma', responsable: 'Sistema', evidencia: 'alerta' },
  { fecha: '19/06', hora: '11:05', tipo: 'decision', evento: 'Esc. Lagos marcó título como "En estudio"', responsable: 'AVN', evidencia: 'cambio' },
  ...
  { fecha: '04/06', hora: '10:00', tipo: 'apertura', evento: 'Apertura del legajo MP-475032', responsable: 'AVN', evidencia: 'sistema' },
];

export const documentos = [
  { id: 1, nombre: 'Título de propiedad', estado: 'validado', responsable: 'Vendedor', fecha: '06/06' },
  ...
  { id: 4, nombre: 'Libre deuda expensas', estado: 'validado', responsable: 'Comprador', fecha: '14/06' },
  { id: 5, nombre: 'Libre deuda ABL', estado: 'validado', responsable: 'Comprador', fecha: '12/06' },
  { id: 6, nombre: 'Comprobante de seña', estado: 'validado', responsable: 'Comprador', fecha: '11/06' },
  { id: 7, nombre: 'Boleto de compraventa', estado: 'validado', responsable: 'Esc. Lagos', fecha: '10/06' },
  { id: 8, nombre: 'DNI partes', estado: 'validado', responsable: 'Sistema', fecha: '04/06' },
];
