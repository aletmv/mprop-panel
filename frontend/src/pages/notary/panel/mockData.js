...
export const operaciones = [
  {
    ...
    progreso: 60,
    pasoActual: 'Análisis',
    tareaEnCurso: 'Esperar nuevo certificado de dominio',
    firma: '25/06/2025',
    diasFirma: 3,
  ...
  },
  {
    ...
    progreso: 95,
    pasoActual: 'Firma',
    tareaEnCurso: 'Coordinar firma del 24/06 con las partes',
    firma: '24/06/2025',
    diasFirma: 2,
  ...
  },
  {
    ...
    progreso: 45,
    pasoActual: 'Análisis',
    tareaEnCurso: 'Verificación dominial y de inhibición',
    firma: '02/07/2025',
    diasFirma: 10,
  ...
  },
  {
    ...
    tareaEnCurso: 'Carga de DNI de las partes',
    firma: '15/07/2025',
    diasFirma: 23,
  ...
  },
  {
    ...
    progreso: 15,
    pasoActual: 'Apertura',
    tareaEnCurso: 'Asignar gestoría y validar partes',
    firma: '28/07/2025',
    diasFirma: 36,
  ...
  },
  {
    ...
    progreso: 100,
    pasoActual: 'Cerrado',
    tareaEnCurso: 'Inscripción en Registro de la Propiedad',
    firma: '18/06/2025',
    diasFirma: -4,
