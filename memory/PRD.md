...
- **Banner carrusel home** (11 jun): reemplaza la franja de ventajas por carrusel estilo MercadoLibre (`src/components/HeroBanner.jsx`): 5 slides con copy definido por el usuario (72% menos gastos de cierre / Costos 100% claros / Identidad biométrica / Reserva protegida / Escribanías en un clic), autoplay 5s, flechas desktop, dots, fondo amarillo
